  ...
  return (
    <header className="public-shell relative z-30 border-b public-rule">
      <div className="mx-auto flex max-w-7xl flex-wrap items-center gap-x-5 px-5 py-4 lg:flex-nowrap lg:px-8">
        ...
        <form action="/autos" role="search" className="order-4 mt-3 flex h-10 w-full min-w-0 items-center rounded-md border public-rule bg-zinc-900/80 lg:order-none lg:mt-0 lg:max-w-xl lg:flex-1">
        ...
        <Link href={sellHref} className="hidden min-h-10 shrink-0 items-center rounded-md bg-orange-600 px-5 text-xs font-bold text-white transition-colors hover:bg-orange-500 lg:inline-flex">Vende tu auto</Link>
        <div className="ml-auto shrink-0 text-xs font-semibold lg:ml-0">
          {!viewer
            ? <Link href="/login" className="inline-flex min-h-10 items-center rounded-md border border-white/15 px-4 text-zinc-200 transition-colors hover:border-orange-400 hover:text-white">Ingresar</Link>
